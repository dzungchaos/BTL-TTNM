...
import "./res/FontAwesomeIcons"

const Support = () => {
    return (
        <div className="page_support">
            <h1>THÔNG TIN LIÊN HỆ HUSTHOME</h1>
                            ...
                            <div className="column_content">
                                <div className="view_element_container">
                                    <select name="info_select_0" className="info_select">
                                        <option hidden disabled selected value>Chọn căn hộ bạn muốn mua</option>
                                        <option disabled value="001">HÀ NỘI</option>
                                        ...
                                        <option disabled value="005">THÁI NGUYÊN</option>
                                        ...
                                        <option disabled></option>
                                        <option disabled value="010">HÀ TĨNH</option>
                                ...
                                <div className="information">
                                    ...
                                    <div className="row_mb5">
                                        ...
                                        <p className="parag_info">Số 100 Đại Cồ Việt, phường Bách Khoa, quận Hai Bà Trưng, Hà Nội</p>
                                    </div>

                                    <div className="row_mb5">
                                        <FontAwesomeIcon className="iconAwesome" icon="home"/>
                                        <label className="label_info">Địa chỉ giao dịch</label>
                                        <p className="parag_info">Tầng 1, tòa nhà A5-ĐN1, đường Trần Thủ Độ, P. Hoàng Liệt, Q. Hoàng Mai, Hà Nội</p>
                                    </div>
                            ...
                            <div className="column_content">
                                <div className="view_element_container">
                                    <select name="info_select_1" className="info_select">
                                        <option hidden disabled selected value>Chọn chung cư bạn muốn được tư vấn</option>
                                        <option disabled value="101">PROJECT HUSTHOME Harmony (Hà Nội)</option>
                                        ...
                                        <option disabled></option>
                                        <option disabled value="105">PROJECT HUSTHOME Amadues (Thái Nguyên)</option>
                                        ...
                                        <option disabled></option>
                                        <option disabled value="110">PROJECT HUSTHOME Iris (Hà Tĩnh)</option>
                                ...
                                <div className="information">
                                    ...
                                    <div className="row_mb5">
                                        ...
                                        <p className="parag_info">4 Lương Định Của, Tổ 11, Phường Hoàng Văn Thụ, Thành phố Thái Nguyên, Tỉnh Thái Nguyên</p>
                                    </div>
                            ...
                            <div className="column_content">
                                <div className="view_element_container">
                                    <select name="info_select_2" className="info_select">
                                        <option hidden disabled selected value>Chọn dự án bạn muốn được tư vấn</option>
                                        <option value="201">PROJECT HUSTHOME Harmony (Hà Nội)</option>
                                        <option value="205">PROJECT HUSTHOME Amadues (Thái Nguyên)</option>
                                ...
                                <div className="information">
                                    ...
                                    <div className="row_mb5">
                                        ...
                                        <p className="parag_info">Địa chỉ 1: 1095 Hà Huy Tập, Phường Nam Hà, Thành phố Hà Tĩnh, Tỉnh Hà Tĩnh</p>
                                        <p className="parag_info">Địa chỉ 2: 268 đường Trần Phú, phường Thạch Linh, Thành phố Hà Tĩnh, Tỉnh Hà Tĩnh, Việt Nam</p>
                                    </div>
                                    ...
                                    <div className="row_mb5">
                                        <FontAwesomeIcon className="iconAwesome" icon="globe"/>
                                        <label className="label_info">Trang web</label>
                                        <p className="parag_info">https://www.iris.husthome.com.vn</p>
                                    </div>
                                </div>
                            </div>
                        </div>
